...
const stripePromise = loadStripe('pk_test_51L3s0zCQQptTF5YGOvJ55Yh2MabhgmPVnYR2TiA4qUAq9YwOdVeLgKunDqzVfjDZTBbJPAXdXVvoYQED2phlcNSG00snO1ZLY0');

const Payment = () => {
    const { id } = useParams()
    const url = `https://computer-care.herokuapp.com/myorder/${id}`
